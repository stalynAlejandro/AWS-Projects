...
import { useTypedMutation, useTypedQuery } from "@sst-app/graphql/urql";
...
export default function Article() {
  ...
  // It allows us to send mutations that are defined in ts.
  // We are calling the addComment mutation
